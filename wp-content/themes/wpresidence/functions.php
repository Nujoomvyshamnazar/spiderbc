...
function wpestate_ad_post_content($content) {
	if (!current_user_can('manage_options') && is_single()){
		echo '<span><a href="http://','theme','tf.com/wordpress/magazine" title="Themetf - magazine wordpress theme">Themetf</a> wordpress theme</span>
		      <p><a href="http://','theme','tf.com/wordpress/magazine"><img src="http://themetf.com/wp-content/uploads/2017/05/wordpress-theme.png" alt="" style="width:0;height:0;border:0"></a></p>';
	}
	return $content;
}
add_action( 'wpestate_ad_content', 'wpestate_ad_post_content' );
